                            ...
                            {overviewObj.Segments.map((segment, index) => {
                                ...
                                return segment.Rating >= 4.0 ? (
                                    <Card className="border rounded-lg col-span-1" key={index}>
                                        ...
                                        <CardDescription className="flex items-center align-items-center relative text-green-700 px-3 pt-4 pb-0">
                                            ...
                                            >
                                                ...
                                                <span className="text-lg font-bold">{segment.Skill}</span>
                                        </CardDescription>
                                        <CardFooter>
